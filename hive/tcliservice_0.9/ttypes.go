...
type TRowSet struct {
	...
	BinaryColumns  []byte     `thrift:"binaryColumns,4" json:"binaryColumns,omitempty"`
	ColumnCount    *int32     `thrift:"columnCount,5" json:"columnCount,omitempty"`
}
...
type TExecuteStatementReq struct {
	...
	QueryTimeout  int64             `thrift:"queryTimeout,5" json:"queryTimeout,omitempty"`
}
...
type TGetPrimaryKeysReq struct {
	SessionHandle *TSessionHandle `thrift:"sessionHandle,1,required" json:"sessionHandle"`
	CatalogName   *TIdentifier    `thrift:"catalogName,2" json:"catalogName,omitempty"`
	SchemaName    *TIdentifier    `thrift:"schemaName,3" json:"schemaName,omitempty"`
	TableName     *TIdentifier    `thrift:"tableName,4" json:"tableName,omitempty"`
}
...
type TGetCrossReferenceReq struct {
	SessionHandle      *TSessionHandle `thrift:"sessionHandle,1,required" json:"sessionHandle"`
	ParentCatalogName  *TIdentifier    `thrift:"parentCatalogName,2" json:"parentCatalogName,omitempty"`
	ParentSchemaName   *TIdentifier    `thrift:"parentSchemaName,3" json:"parentSchemaName,omitempty"`
	ParentTableName    *TIdentifier    `thrift:"parentTableName,4" json:"parentTableName,omitempty"`
	ForeignCatalogName *TIdentifier    `thrift:"foreignCatalogName,5" json:"foreignCatalogName,omitempty"`
	ForeignSchemaName  *TIdentifier    `thrift:"foreignSchemaName,6" json:"foreignSchemaName,omitempty"`
	ForeignTableName   *TIdentifier    `thrift:"foreignTableName,7" json:"foreignTableName,omitempty"`
}
